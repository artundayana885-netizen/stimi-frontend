...
export function Notifications({ notifications: externalNotifications, setNotifications: setExternalNotifications }) {
  ...
  const [localNotifications, setLocalNotifications] = useState(FALLBACK_NOTIFICATIONS);
    ...
    <div style={{ fontFamily: "'Inter', 'Segoe UI', sans-serif", color: '#111827' }}>
      ...
      <div style={{ background: '#fff', borderRadius: 14, padding: 24, marginBottom: 16, border: '1px solid #F0F2F5', boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
          ...
          <h2 style={{ margin: 0, fontSize: 15, fontWeight: 600, color: '#111827' }}>Apariencia</h2>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            <div style={{ fontSize: 14, fontWeight: 600, color: '#111827' }}>Modo oscuro</div>
          ...
          <div
            ...
            style={{ width: 44, height: 24, borderRadius: 12, background: darkMode ? '#16a34a' : '#D1D5DB', position: 'relative', cursor: 'pointer', transition: 'background .2s', flexShrink: 0 }}
          >
            <div style={{ width: 20, height: 20, borderRadius: '50%', background: '#fff', position: 'absolute', top: 2, left: darkMode ? 22 : 2, transition: 'left .2s', boxShadow: '0 1px 4px rgba(0,0,0,0.2)' }} />
          </div>
        </div>
      </div>
